...
![winver command](../images/winver.png)
...
![EoPLoadDriver.cpp](../images/eoploaddriver.png)
...
![ExploitCapcom.cpp](../images/exploitcapcom.png)
...
![](../images/setup-wizard.png)

* Add the binary to execute during explotation.

![](../images/setup-wizard2.png)
