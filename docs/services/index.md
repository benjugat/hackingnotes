...
-   **[PORT 80/tcp, 443/tcp - HTTP Server](http.md)**

    ---

    It is a brief methodology to use in front of web applications.

-   **[PORT 143/tcp, 993/tcp - IMAP](imap.md)**
...
-   **[PORT 1100/tcp - Java RMI](java-rmi.md)**
...
-   **[PORT 3306/tcp - MySQL Server](mysql.md)**

    ---

    show tables; select from table; select column from table;

-   **[PORT 2049/tcp - NFS](nfs.md)**
...
-   **[PORT 111/tcp - RPCBind](rpcbind.md)**
...
-   **[PORT 139/tcp, 445/tcp - SMB](smb.md)**
...
-   **[PORT 1433/tcp - Microsoft SQL Server](sql-server.md)**
